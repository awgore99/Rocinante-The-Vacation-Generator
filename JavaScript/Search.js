...
// How assign time to current time (var timeNow) and +7 days (var timeNow_)
    ...
    var getFlightStatus = `https://tripadvisor16.p.rapidapi.com/api/v1/flights/searchFlights?sourceAirportCode=${airportInfo[0][1]}&destinationAirportCode=${airportInfo[1][1]}&date=${timeNow}&itineraryType=ONE_WAY&sortOrder=PRICE&numAdults=1&numSeniors=0&classOfService=ECONOMY&returnDate=${timeNow}&currencyCode=USD`;
...
var getTransitStatus = `https://multimodal-trip-planner.p.rapidapi.com/v1/routing?waypoints=${airportInfo[0][2]}%2C${airportInfo[0][3]}%7C${airportInfo[1][2]}%2C${airportInfo[1][3]}&mode=transit`;
