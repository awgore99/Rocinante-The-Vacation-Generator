...
//fetch and .then API's to search for information, taking in the array of starting and ending locations from search.js
...
//          create another dropdown <select> menu for the user to select housing accommodations
//      populate the rightmost container with information on things to do in the area
//          either a dropdown menu or checkboxes for the user to potentially select multiple options
//
...
const {inputEndingCity} = require('./Search.js');
